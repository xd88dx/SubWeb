export const shorturlConfig = [
  {
    label: 'myurls-cf',
    value: 'https://url.xzv.dpdns.org/short'
  },
  {
    label: 'shlink-self',
...
export const backendConfig = [
  ...
  {
    label: 'asdlokj1qpi233(tindy2013-增强版)',
    value: 'https://sub.933993.xyz:1443/sub?'
  }
]
export const externalConfig = [
  {
    ...
    options: [
      {
        label: 'CM_Online_MultiCountry 同步定制 精简',
        value: 'https://raw.githubusercontent.com/xd88dx/Sub-Config/main/ACL4SSR_Online_MultiCountry_mini.ini'
      },
      {
        label: 'CM_Online_MultiCountry 同步定制 全显',
        value: 'https://raw.githubusercontent.com/xd88dx/Sub-Config/main/ACL4SSR_Online_MultiCountry_full.ini'
      }
    ]
  },
  {
